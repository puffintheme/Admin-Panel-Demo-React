                    ...
                    <ul className="metismenu" id="menu">
                        ...
                        <li>
                            <Link to="/dashboard" className="waves-effect">
                                <i className="ti-home"></i><span className="badge badge-primary badge-pill float-right">2</span> <span> Dashboard </span>
                            </Link>
                        </li>
                        <li>
                            <Link to="calendar" className="waves-effect"><i className="ti-calendar"></i><span> Calendar </span></Link>
                        </li>
                        <li id="temp">
                            <Link to="/#" className="waves-effect"><i className="ti-email"></i><span> Email <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                        ...
                        <li>
                            <Link to="/#" className="waves-effect"><i className="ti-package"></i> <span> UI Elements <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span> </Link>
                            <ul className="submenu">
                        ...
                        <li>
                            <Link to="/#" className="waves-effect"><i className="ti-receipt"></i><span> Forms <span className="badge badge-pill badge-success float-right">9</span> </span></Link>
                            <ul className="submenu">
                        ...
                        <li>
                            <Link to="/#" className="waves-effect"><i className="ti-pie-chart"></i><span> Charts <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                            <ul className="submenu">
                        ...
                        <li>
                            <Link to="/#" className="waves-effect"><i className="ti-view-grid"></i><span> Tables <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                            <ul className="submenu">
                        ...
                        <li>
                            <Link to="/#" className="waves-effect"><i className="ti-face-smile"></i> <span> Icons  <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span></span> </Link>
                            <ul className="submenu">
                        ...
                        <li>
                            <Link to="/#" className="waves-effect"><i className="ti-location-pin"></i><span> Maps <span className="badge badge-pill badge-danger float-right">2</span> </span></Link>
                            <ul className="submenu">
                        ...
                        <li>
                            <Link to="/#" className="waves-effect"><i className="ti-archive"></i><span> Authentication <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                            <ul className="submenu">
                        ...
                        <li>
                            <Link to="/#" className="waves-effect"><i className="ti-support"></i><span> Extra Pages <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                            <ul className="submenu">
                        ...
                        <li>
                            <Link to="/#" className="waves-effect"><i className="ti-bookmark-alt"></i><span> Email Templates <span className="float-right menu-arrow"><i className="mdi mdi-chevron-right"></i></span> </span></Link>
                            <ul className="submenu">
